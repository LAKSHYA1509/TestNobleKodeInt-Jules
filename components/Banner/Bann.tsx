        ...
        <BackgroundBeamsWithCollision  className ="bg-black" >
            ...
            <h2 className="!text-4xl  md:!text-5xl lg:!text-7xl relative z-20 font-bold text-center text-white dark:text-white font-sans tracking-tight">
                ...
                <div className="relative mx-auto inline-block w-max [filter:drop-shadow(0px_1px_3px_rgba(27,_37,_80,_0.14))]">
                    <div className="absolute left-0 top-[1px] bg-clip-text bg-no-repeat text-transparent bg-gradient-to-r py-4 [text-shadow:0_0_rgba(0,0,0,0.1)]">
                        <span className="max-sm:flex  flex-wrap w-96">{span}</span>
                    </div>
                    <div className="relative bg-clip-text text-transparent bg-no-repeat bg-gradient-to-r from-cyan-300 via-blue-400 to-blue-600  py-4">
                        <span className="max-sm:flex  flex-wrap w-96">{span}</span>
                    </div>
                </div>
            </h2>
