                    ...
                    {partners.map((partner, index) => (
                        ...
                        >
                            <div className="relative w-full h-full flex items-center justify-center">
                                {/* Using text-based logos for better compatibility */}
                                <div className="text-gray-400 group-hover:text-white transition-colors duration-300 font-semibold text-lg text-center">
                                    {partner.name}
                                </div>                                
                            </div>
                        </div>
