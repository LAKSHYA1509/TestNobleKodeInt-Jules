...
const Carousel3D = ({
    ...
    return (
        <section id="carousel3d" className=" min-w-full mx-auto">
      ...
      min-w-[350px] md:min-w-[1000px] max-w-7xl  ">
                ...
                <div
                    ...
                    ref={carouselRef}
                >
                    <div className="absolute top-0 left-20 right-0 w-full h-full flex items-center justify-center ">
                ...
                hover:shadow-md flex flex-col`}>
                                        ...
                                        <div className="mt-4">
                                            <div className="flex flex-wrap gap-2 mb-4">
                                                {item.tags.map((tag, idx) => (
                                                    <span
                                                        key={idx}
                                                        className="px-2 py-1 text-gray-600 rounded-full text-xs animate-pulse-slow"
                                                    >
                                                        {tag}
                                                    </span>
                                                ))}
                    ...
                    {!isMobile && (
                        <>
                            ...
                            <button
                                className="absolute right-1 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/80 rounded-full flex items-center justify-center text-gray-500 hover:bg-white z-30 shadow-md transition-all hover:scale-110"
