...
function MenubarTrigger({ className, children, ...props }: MenubarTriggerProps) {
  ...
  return (
    <button
      ...
      role="menuitem"
      className={cn(
        "flex cursor-default select-none items-center rounded-sm px-3 py-1.5 text-[2xl] font-medium outline-none focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground ",
        className
      )}
